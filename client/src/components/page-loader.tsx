...
export function PageLoader() {
	...
	return (
		<div className="flex min-h-screen flex-col items-center justify-center gap-5 bg-slate-50 dark:bg-slate-950" role="status" aria-live="polite" aria-busy="true">
			<div className="text-brand flex items-center gap-2">
				<Siren className="id-logo-pulse h-7 w-7" aria-hidden="true" />
				<span className="text-2xl font-bold">IncidentDesk</span>
			</div>
